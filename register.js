...
window.addEventListener('DOMContentLoaded', (e) => {
    ...
    async function addData(event) {
        ...
        const problemdiscription = document.querySelector("#problemdiscription").value;
    ...
    complaint_dropdown.addEventListener('change', (e) => {
        ...
        optgroup.innerHTML = [`<option selected disabled>Select Category</option>`,options_html].join("");
    })
})